...
Mortality rate among **New mothers** and **Expecting mothers** is very high. This is mostly due to them not getting enough **resources** and **guidance** to help or do not get **immediate help** when required.

This can be avoided if the expecting mothers have a way to communicate with others on what they are experiencing and how they should proceed with it. Who better to seek support than the **others in the same situation?**

**MatHeal** is a web application that helps an expecting mother to **connect** with other *expecting mothers, doulas, midwives* and *suppliers of baby products* and *medicine*.
...
1. Clone the repo
   ```sh
   git clone git@github.com:VishrutAggarwal/MatHeal.git
   ```
